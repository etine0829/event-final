<div>
    ...
    <div class="flex items-center space-x-4">
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-cloak x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2 z-20">
            ...
            <div class="flex justify-center items-center min-h-screen">
                <div class="p-5 bg-white rounded-lg custom-gradient-ring">
                    ...
                    <div class="flex justify-start mb-10">
                        ...
                        <!-- <a href="" class="bg-blue-500 text-white px-3 py-2 text-sm font-medium border rounded-lg focus:outline-none">Click to Update</a> -->
                    </div>
                            ...
                            <div class="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 border-b-2 border-blue-500 pb-4 mt-4">
                                ...
                                <div class="w-full md:w-1/4 flex items-center justify-center">
                                    ...
                                    @if ($participant->participant_photo && Storage::exists('public/participant_photo/' . $participant->participant_photo))
                                            <a href="{{ asset('storage/participant_photo/' . $participant->participant_photo) }}" class="rounded-full" title="Click to view Picture">
                                                <img src="{{ asset('storage/participant_photo/' . $participant->participant_photo) }}" class="w-32 h-32 rounded-lg object-cover border border-gray-300 mb-4" data-fancybox data-caption="{{ $participant->participant_name}}">
                                            </a>
                                        @else
                                            <img data-fancybox data-caption="{{ $participant->participant_name}}" src="{{ asset('assets/img/user.png') }}" class="w-32 h-32 rounded-lg object-cover  mb-4"  title="Click to view Picture">
                                        @endif
                                </div>
                    ...
                    <div x-data="{ showButton: false }" @scroll.window="showButton = (window.scrollY > 100)" class="fixed bottom-8 right-8">
                        <button 
                            ...
                            style="display: none;">
                            <i class="fa-sharp fa-solid fa-arrow-up"></i> Up <!-- Upward arrow symbol -->
                        </button>
                    </div>
