                                ...
                                <tr class="hover:bg-gray-100" wire:model="selectedCategory">
                                    ...
                                    <td class="text-black border border-gray-400 px-1 py-1">
                                        <div class="flex justify-center items-center space-x-2">
                                            ...
                                            <form id="deleteSelected" action="{{ route('admin.category.destroy', [':id', ':category_id']) }}" method="POST" onsubmit="return ConfirmDeleteSelected(event, '{{ $category->id }}', '{{ $category->category_id }}', '{{ $category->category_name }}', '{{ $category->score }}');">
                                                @csrf
                                                @method('DELETE')
