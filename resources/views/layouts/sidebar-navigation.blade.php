        ...
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow mr-0.5">
            <ul class="flex flex-col py-2 space-y-1 text-gray-800" >
                ...
                <li>
                    ...
                    {{ request()->routeIs('v.dashboard') ? ' border-l-yellow-500 bg-[#172029] text-white' : 'hover:bg-blue-800 dark:hover:bg-slate-700 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-yellow-500 hover:text-white' }}">
                        <span class="inline-flex justify-center items-center ml-4">
