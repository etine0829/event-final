...
@elseif (Auth::user()->hasRole('admin_staff'))
    ...
    <div class="transition-all duration-300 h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gradient-to-r from-yellow-400 to-red-500 text-black dark:text-white">
